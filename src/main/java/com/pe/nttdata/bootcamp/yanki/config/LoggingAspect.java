package com.pe.nttdata.bootcamp.yanki.config;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.pe.nttdata.bootcamp.yanki.commons.AspectEnum;
import com.pe.nttdata.bootcamp.yanki.dto.AppProcesoLogDto;
import com.pe.nttdata.bootcamp.yanki.util.DateUtils;
...
public class LoggingAspect {
   ...
   */
  @Around(value = "execution(* com.pe.nttdata.bootcamp.yanki.expose.web..*(..))")
  ...
  private void getProcees(ProceedingJoinPoint joinPoint, Object response) {
    ...
    log.info("\u001B[33mLog Execution - ** \u001B[36m{} \u001B[33m** \u001B[0m",
            logSystem.toString());
